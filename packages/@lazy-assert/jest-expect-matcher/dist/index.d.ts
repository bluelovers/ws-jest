...
export type IExpectAsymmetricMatcher = ReturnType<AsymmetricMatchers["anything"]>;
export declare const SymbolTypeofAsymmetricMatcher: unique symbol;
/**
...
export type ICustomAsymmetricMatcher<TMatcher extends (...args: any[]) => any = (...args: any[]) => any> = (...args: Parameters<TMatcher>) => IAsymmetricMatcher;
export declare function _isAsymmetricMatcher<T>(matcher: unknown | IAsymmetricMatcher<T>): matcher is IAsymmetricMatcher<T>;
/**
 * 概念：建立一個「容器」Matcher
 *
 ...
 */
export declare const anyOf: (matchers: (unknown | IAsymmetricMatcher)[]) => {
 ...
 */
export declare const allOf: (matchers: (unknown | IAsymmetricMatcher)[]) => {
