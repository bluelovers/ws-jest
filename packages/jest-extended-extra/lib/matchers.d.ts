export declare const matchers: {
    ...
    readonly toBeInteger: (this: IMatcherContext, received: number) => ICustomMatcherResult;
    readonly toBeInfinity: typeof import("./matchers/toBeInfinity").toBeInfinity;
    readonly toBeFloat: (this: IMatcherContext, received: number) => ICustomMatcherResult;
