...
let u = /*#__PURE__*/ function(t) {
  return t.array = "Array", t.boolean = "boolean", t.date = "Date", t.function = "function", 
  t.number = "number", t.object = "Object", t.regexp = "RegExp", t.string = "string", 
  t;
}({});

function ChaiPluginAssertType(t, d) {
  Object.entries(u).forEach(function([e, n]) {
...
function list() {
  return d(Object.keys(u).concat([ "float", "integer", "nan", "zero", "positive", "negative" ])).sort();
}
...
export { c as ChaiPlugin, ChaiPluginAssertType, u as EnumTypeDetect, _assertType, addToAssertion, addToAssertionLazy, c as default, install, list, l as typeOf };
